...
class ValidService(Service):
    ...
    async def handle_request(self, request, _=None):
...
class NonAsyncService(Service):
    ...
    def handle_request(self, request, _=None):
...
class ExtraParamService(Service):
    ...
    async def handle_request(self, request, _=None, extra_param=None):
...
class ContextAwareService(Service):
    ...
    async def handle_request(self, request, ctx=None):
        ...
        ctx = ctx or {}
        return {"status": "success", "data": request, "context": ctx}
...
def test_handle_request_is_async():
    ...
    assert (
        inspect.iscoroutinefunction(method) is True
    ), "Abstract method should be a coroutine function"

    # Check the valid implementation
    valid_method = ValidService.handle_request
    assert (
        inspect.iscoroutinefunction(valid_method) is True
    ), "Implementation should be a coroutine function"
