...
async def test_endpoint_call_with_model_request():
    ...
    with patch("khive.connections.endpoint.Endpoint._call_aiohttp") as mock_call_aiohttp:
        ...
        endpoint.create_payload = lambda *args, **kwargs: original_create_payload(*args, **kwargs)
...
async def test_endpoint_call_aiohttp_with_server_error():
    ...
    response_mock.history = []
    response_mock.headers = {}
    response_mock.raise_for_status = AsyncMock(side_effect=aiohttp.ClientResponseError(
