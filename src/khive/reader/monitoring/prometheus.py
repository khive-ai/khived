...
SEARCH_REQUESTS = Counter(
    "khive_reader_search_requests_total", "Total number of search requests", ["status"]
)
...
INGESTION_LATENCY = Histogram(
    "khive_reader_ingestion_latency_seconds", "Document ingestion latency in seconds"
)

PROCESSING_LATENCY = Histogram(
    "khive_reader_processing_latency_seconds", "Document processing latency in seconds"
)
...
VECTOR_COUNT = Gauge("khive_reader_vector_count", "Total number of vectors stored")

DOCUMENT_COUNT = Gauge(
    "khive_reader_document_count", "Total number of documents stored"
)
...
EMBEDDING_LATENCY = Histogram(
    "khive_reader_embedding_latency_seconds", "Time to generate embeddings in seconds"
)

TASK_QUEUE_SIZE = Gauge("khive_reader_task_queue_size", "Number of tasks in the queue")
