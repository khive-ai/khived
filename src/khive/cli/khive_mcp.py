...
from khive.connections.mcp_server import (
    _KHIVEMCP_OP_META,
    GroupConfig,
    ServiceConfig,
    load_config,
...
async def run_khivemcp_server(
    config: ServiceConfig | GroupConfig, method: Literal["stdio", "sse"] = "stdio"
) -> None:
    ...
    try:
        ...
        if method == "stdio":
            ...
            raise ValueError(
                f"Invalid transport method '{method}'. Supported methods are 'stdio' and 'sse'."
            )
    except Exception as e:
        print(
